...
| [^运营指导] | 超级用户<br/>升级<br/>呼叫               | 信息事件                                                              | 应用事件<br/>事件<br/>解析度<br/>根本原因分析<br/>事项管理<br/>性能&调整                                     | 基础设施事件<br/>事件<br/>解析度<br/>根本原因分析<br/>[^机房管理]<br/>工作量<br/>调度<br/>监控<br/>性能&调整<br/>环境管理       |
...
荷兰十个组织的研究[Best 2015a]指出，使用敏捷方法的服务组织中仍然存在服务管理流程。表5-3显示了十个组织分配给敏捷开发团队的范围。灰色意味着没有涉及，但也没有真正的预期。 红色意味着不涉及。黄色意味着部分涉及,绿色意味着涉及。这些数字反映了实施某一方面领域的十个组织的数量。特别是对信息管理的重视程度不够令人担忧。 而且，大多数战略框架的缺乏是显而易见的。
...
| 运营指导 |       超级用户<br/>升级上报<br/>呼叫       |               信息事件<br/>看板                | 应用事件<br/>事项解决方案<br/>根本原因分析<br/>事件管理<br/>性能调优         | 基础架构事件<br/>事件解决方案<br/>根本原因分析<br/>看板<br/>机房管理<br/>工作负载<br/>调度<br/>监控<br/>性能调优<br/>环境管理 |
